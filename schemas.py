...
# Lead schema for landing page lead generation
class Lead(BaseModel):
    ...
    last_name: str = Field(..., description="Prospect last name")
    phone: str = Field(..., min_length=5, max_length=30, description="Phone number")
    email: EmailStr = Field(..., description="Email address")
    focus: Optional[str] = Field(None, description="Focus area selected (bedroom/living)")
